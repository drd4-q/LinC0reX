...
# ifdef	__APPLE__
	adr	r9,wg_poly1305_blocks_neon
...
#  endif
	...
	addne	r11,r11,#(wg_poly1305_blocks_neon-.Lpoly1305_init)
# endif
# ifdef	__thumb2__
...
#ifdef __KERNEL__
.globl	wg_poly1305_blocks_neon
#endif
.type	wg_poly1305_blocks_neon,%function
.align	5
wg_poly1305_blocks_neon:
...
.Lno_data_neon:
	ret					@ bx	lr
.size	wg_poly1305_blocks_neon,.-wg_poly1305_blocks_neon
