...
{
	if (nonce_len == 8)
		wg_chacha20poly1305_encrypt(dst, src, src_len, ad, ad_len,
...
static bool __init chacha20poly1305_selftest(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(chacha20poly1305_enc_vectors); ++i) {
		...
		sg_init_one(sg_src, computed_output,
			    chacha20poly1305_enc_vectors[i].ilen +
				POLY1305_MAC_SIZE);
		ret = wg_chacha20poly1305_encrypt_sg_inplace(sg_src,
			chacha20poly1305_enc_vectors[i].ilen,
			chacha20poly1305_enc_vectors[i].assoc,
			chacha20poly1305_enc_vectors[i].alen,
	...
	for (i = 0; i < ARRAY_SIZE(chacha20poly1305_dec_vectors); ++i) {
		memset(computed_output, 0, MAXIMUM_TEST_BUFFER_LEN);
		ret = wg_chacha20poly1305_decrypt(computed_output,
	...
	for (i = 0; i < ARRAY_SIZE(chacha20poly1305_dec_vectors); ++i) {
		...
		sg_init_one(sg_src, computed_output,
			    chacha20poly1305_dec_vectors[i].ilen);
		ret = wg_chacha20poly1305_decrypt_sg_inplace(sg_src,
			chacha20poly1305_dec_vectors[i].ilen,
			chacha20poly1305_dec_vectors[i].assoc,
			chacha20poly1305_dec_vectors[i].alen,
			get_unaligned_le64(chacha20poly1305_dec_vectors[i].nonce),
	...
	for (i = 0; i < ARRAY_SIZE(xchacha20poly1305_enc_vectors); ++i) {
		memset(computed_output, 0, MAXIMUM_TEST_BUFFER_LEN);
		wg_xchacha20poly1305_encrypt(computed_output,
	...
	for (i = 0; i < ARRAY_SIZE(xchacha20poly1305_dec_vectors); ++i) {
		memset(computed_output, 0, MAXIMUM_TEST_BUFFER_LEN);
		ret = wg_xchacha20poly1305_decrypt(computed_output,
	...
	for (total_len = POLY1305_MAC_SIZE; IS_ENABLED(DEBUG_CHACHA20POLY1305_SLOW_CHUNK_TEST)
		...
		for (i = 0; i <= total_len; ++i) {
			for (j = i; j <= total_len; ++j) {
				...
				if (!wg_chacha20poly1305_encrypt_sg_inplace(sg_src,
					total_len - POLY1305_MAC_SIZE, NULL, 0,
					0, enc_key001, &simd_context))
					goto chunkfail;
				wg_chacha20poly1305_encrypt(computed_output,
					computed_output,
					total_len - POLY1305_MAC_SIZE, NULL, 0, 0,
					enc_key001);
				if (memcmp(computed_output, input, total_len))
					goto chunkfail;;
				if (!wg_chacha20poly1305_decrypt(computed_output,
				...
				if (!wg_chacha20poly1305_decrypt_sg_inplace(sg_src,
